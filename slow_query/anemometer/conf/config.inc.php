...
// start of all hosts
$conf['datasources']['erp-logis-db1-slow'] = array(
        'host'  => 'localhost',
        'port'  => 3306,
        'db'    => 'slow_query_log',
        'user'  => 'root',
        'password' => '',
        'tables' => array(
                'erp_logis_db1_review' => 'fact',
                'erp_logis_db1_review_history' => 'dimension'
        ),
        'source_type' => 'slow_query_log'
);


$conf['datasources']['erp-logis-db2-slow'] = array(
        'host'  => 'localhost',
        'port'  => 3306,
        'db'    => 'slow_query_log',
        'user'  => 'root',
        'password' => '',
        'tables' => array(
                'erp_logis_db2_review' => 'fact',
                'erp_logis_db2_review_history' => 'dimension'
        ),
        'source_type' => 'slow_query_log'
);

$conf['datasources']['erp-logis-db3-slow'] = array(
        'host'  => 'localhost',
        'port'  => 3306,
        'db'    => 'slow_query_log',
        'user'  => 'root',
        'password' => '',
        'tables' => array(
                'erp_logis_db3_review' => 'fact',
                'erp_logis_db3_review_history' => 'dimension'
        ),
        'source_type' => 'slow_query_log'
);


$conf['datasources']['erp-logis-db4-slow'] = array(
        'host'  => 'localhost',
        'port'  => 3306,
        'db'    => 'slow_query_log',
        'user'  => 'root',
        'password' => '',
        'tables' => array(
                'erp_logis_db4_review' => 'fact',
                'erp_logis_db4_review_history' => 'dimension'
        ),
        'source_type' => 'slow_query_log'
);

$conf['datasources']['erp-logis-db5-slow'] = array(
        'host'  => 'localhost',
        'port'  => 3306,
        'db'    => 'slow_query_log',
        'user'  => 'root',
        'password' => '',
        'tables' => array(
                'erp_logis_db5_review' => 'fact',
                'erp_logis_db5_review_history' => 'dimension'
        ),
        'source_type' => 'slow_query_log'
);


$conf['datasources']['erp-logis-db6-slow'] = array(
        'host'  => 'localhost',
        'port'  => 3306,
        'db'    => 'slow_query_log',
        'user'  => 'root',
        'password' => '',
        'tables' => array(
                'erp_logis_db6_review' => 'fact',
                'erp_logis_db6_review_history' => 'dimension'
        ),
        'source_type' => 'slow_query_log'
);

$conf['datasources']['erp-logis-db7-slow'] = array(
        'host'  => 'localhost',
        'port'  => 3306,
        'db'    => 'slow_query_log',
        'user'  => 'root',
        'password' => '',
        'tables' => array(
                'erp_logis_db7_review' => 'fact',
                'erp_logis_db7_review_history' => 'dimension'
        ),
        'source_type' => 'slow_query_log'
);

$conf['datasources']['erp-logis-db8-slow'] = array(
        'host'  => 'localhost',
        'port'  => 3306,
        'db'    => 'slow_query_log',
        'user'  => 'root',
        'password' => '',
        'tables' => array(
                'erp_logis_db8_review' => 'fact',
                'erp_logis_db8_review_history' => 'dimension'
        ),
        'source_type' => 'slow_query_log'
);
